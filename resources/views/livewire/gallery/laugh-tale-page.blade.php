<div class="p-4 mx-auto max-w-7xl md:p-10">
    <p class="p-4 reveal heartbeat text-center">Developed and presented for my beloved, preciouss, gorgeouss, kyotteouss, pwincess and wifee, Dini Nadia Sahdiah.</p>
    ...
    <div class="columns-2 gap-5 md:columns-3 lg:columns-3 xl:columns-4">
        @foreach ($laughtales as $lt)
            <div class="reveal heartbeat group cursor-pointer mb-5 lg:mb-8 break-inside-avoid 
    rounded-xl border border-white/10 
    bg-white/5 backdrop-blur 
    shadow-lg hover:shadow-pink-500/30 
    transition-all duration-500" onclick="this.classList.toggle('active')">
