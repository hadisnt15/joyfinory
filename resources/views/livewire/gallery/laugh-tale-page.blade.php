<div class="p-4 mx-auto max-w-7xl md:p-10">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
        ...
        <div
            class="reveal group gallery-card cursor-pointer mb-5 lg:mb-8 rounded-xl border border-white/10 bg-white/5 backdrop-blur shadow-lg transition-all duration-500"
            onclick="
